# Full Project Code Mail : tajfaizan254@gmail.com
# If you get error then Mail : tajfaizan254@gmail.com
import cv2
import numpy as np
import face_recognition # Fixed typo: removed the 's'

# Load and convert the first image
...
# Load and convert the second image
...
# Fixed: Changed [1] to [0] because face_encodings returns a list, 
# and you usually want the first face found.
...
# Displaying the result on the test image
...
cv2.waitKey(0) # Fixed typo: changed waitKeys to waitKey
